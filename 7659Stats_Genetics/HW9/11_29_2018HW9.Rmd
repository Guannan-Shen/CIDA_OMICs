...
# hierarchical clustering
par(mfrow = c(1,2))
plclust(hclust(d, "single"), xlab = "Yeast",main = "Cluster Dendrogram")
plclust(hclust(d, "complete"), xlab = "Yeast",main = "Cluster Dendrogram")
plclust(hclust(d, "average"), xlab = "Yeast",main = "Cluster Dendrogram")
plclust(hclust(d, "centroid"), xlab = "Yeast",main = "Cluster Dendrogram")
