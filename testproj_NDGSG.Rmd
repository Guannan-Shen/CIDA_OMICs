...
colnames(colors4plot) <- "Treatment Group"
...
plotDendroAndColors(dendro=content.hclust, colors=colors4plot, main="Normal vs. Tumor Hierachical Clustering", ylab="1-Pearson Correlation",cex.dendroLabels = 0.45)
dev.off()
```
